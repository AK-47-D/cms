...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/statistic/**",  "anon");//静态资源不拦截
        filterChainDefinitionMap.put("/manage/login", "anon");//anon 可以理解为不拦截
        filterChainDefinitionMap.put("/manage/doLogin", "anon");//anon 可以理解为不拦截

        // <!-- 过滤链定义，从上向下顺序执行，一般将 /**放在最为下边 -->:这是一个坑呢，一不小心代码就不好使了;
        // <!-- authc:所有url都必须认证通过才可以访问; anon:所有url都都可以匿名访问-->
        filterChainDefinitionMap.put("/manage/**", "authc,roles[manage]");
