<head>
    ...
    <!-- Morris chart -->
    <link rel="stylesheet" href="/cms/bower_components/morris.js/morris.css">
    <!-- jvectormap -->
    <link rel="stylesheet" href="/cms/bower_components/jvectormap/jquery-jvectormap.css">
    <!-- Date Picker -->
    <link rel="stylesheet" href="/cms/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
    <!-- Daterange picker -->
    <link rel="stylesheet" href="/cms/bower_components/bootstrap-daterangepicker/daterangepicker.css">
    <!-- bootstrap wysihtml5 - text editor -->
    <link rel="stylesheet" href="/cms//cms/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
...
<!-- jQuery UI 1.11.4 -->
<script src="/cms/bower_components/jquery-ui/jquery-ui.min.js"></script>
...
<!-- Morris.js charts -->
<script src="/cms/bower_components/raphael/raphael.min.js"></script>
<script src="/cms/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
...
<!-- jQuery Knob Chart -->
<script src="/cms/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="/cms/bower_components/moment/min/moment.min.js"></script>
<script src="/cms/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
<script src="/cms/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
<!-- Bootstrap WYSIHTML5 -->
